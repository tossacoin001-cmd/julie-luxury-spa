...
const services = [
  {
    ...
    description:
      "A bespoke facial experience using premium-grade serums and techniques tailored to your skin type. Leave with a visible glow.",
    duration: 75,
    price: 35000,
    badge: "Most Popular",
    badgeColor: "bg-[var(--color-spa-green)] text-white",
    accent: "var(--color-spa-green)",
    emoji: "✨",
  },
  {
    ...
    description:
      "Targeted pressure techniques to dissolve tension, improve circulation, and ease chronic muscle pain. Full-body transformation.",
    duration: 90,
    price: 45000,
    badge: null,
    accent: "var(--color-spa-earth)",
    emoji: "🌿",
  },
  {
    ...
    description:
      "A full-body exfoliation ritual using natural botanical scrubs that buff away dullness and reveal radiant, silky skin.",
    duration: 60,
    price: 28000,
    badge: null,
    accent: "var(--color-spa-orange)",
    emoji: "🍃",
  },
  {
    id: "bridal-package",
    ...
    description:
      "A 3-session pre-wedding treatment plan covering face, body, and hands — so you walk down the aisle absolutely radiant.",
    duration: 210,
    price: 120000,
    badge: "Premium",
    badgeColor: "bg-[var(--color-spa-gold)] text-[var(--color-spa-green-dark)]",
    accent: "var(--color-spa-gold)",
    emoji: "💍",
  },
  {
    id: "mani-pedi-luxury",
    ...
    description:
      "Premium nail care with hot stone treatment, paraffin wrap, and your choice of long-lasting polish. Pure indulgence.",
    duration: 90,
    price: 22000,
    badge: null,
    accent: "var(--color-spa-orange-light)",
    emoji: "💅",
  },
  {
    id: "couples-retreat",
    ...
    description:
      "Side-by-side massages, a shared aromatherapy soak, and champagne — the perfect experience for two.",
    duration: 120,
    price: 85000,
    badge: "Gift Favorite",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            reset for your body, skin, and mind.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service) => (
            <div
              key={service.id}
              className="group relative bg-white rounded-2xl p-6 hover:shadow-xl transition-all duration-300 border border-[var(--color-spa-stone)] hover:border-transparent hover:-translate-y-1"
            >
              {/* Badge */}
              {service.badge && (
                <span
                  className={`absolute top-4 right-4 text-[10px] font-medium px-2.5 py-1 rounded-full tracking-wide ${service.badgeColor}`}
                  style={{ fontFamily: "var(--font-inter)" }}
                >
                  {service.badge}
                </span>
              ...
              {/* Emoji icon */}
              <div className="w-12 h-12 rounded-xl bg-[var(--color-spa-cream-dark)] flex items-center justify-center text-2xl mb-4">
                {service.emoji}
              </div>
              ...
              <Link
                ...
                className="group/btn inline-flex items-center gap-2 text-sm font-medium text-[var(--color-spa-green)] hover:text-[var(--color-spa-green-dark)] transition-colors"
                style={{ fontFamily: "var(--font-inter)" }}
              >
                Book This Treatment
                <ArrowRight
        ...
        <div className="text-center mt-14">
          <p
            className="text-sm text-[var(--color-spa-muted)] mb-4"
            style={{ fontFamily: "var(--font-inter)" }}
          >
            Can't decide? Let us help you choose the perfect treatment.
          </p>
          <a
